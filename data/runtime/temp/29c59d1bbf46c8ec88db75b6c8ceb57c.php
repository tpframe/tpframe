<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"./theme/frontend/default/index\index.html";i:1506652624;s:36:"./theme/frontend/default/layout.html";i:1501150982;s:43:"./theme/frontend/default/layout\header.html";i:1501150982;s:43:"./theme/frontend/default/layout\footer.html";i:1505802386;}*/ ?>
<?php
use tpfcore\Core;
    ...
    <div class="mycontainer bgwhite clearfix p20 pB40" style="margin-top: 20px;">
        ...
        <section class="home-case">
            ...
            <div class="p20 text-center">
                <a href="<?php echo url('index/cases',['cid'=>7]); ?>" class="more2 xh-zoomIn">全部案例</a>
            </div>
        </section>
    </div>
    <!-- about -->
    ...
    <div class="mycontainer bgwhite clearfix p20 pB40" style="margin-top: 20px;">
        ...
        <div class="bloghome mT20">
            ...
            <div class="thumbnail">
                ...
                <div class="caption">
                    <h4>
					<a target="_blank" href="<?php echo url('posts/show',['id'=>$vo['id']]); ?>"><?php echo StringHelper::msubstr($vo['title'],0,10); ?></a>
				</h4>
        ...
        <div class="p20 text-center">
            <a href="<?php echo url('posts/index',['cid'=>1]); ?>" class="more2 xh-zoomIn" target="_blank">全部博客</a>
        </div>
    </div>
