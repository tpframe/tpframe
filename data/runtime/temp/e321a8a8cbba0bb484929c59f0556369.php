<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"./theme/frontend/default/posts\index.html";i:1500441178;s:36:"./theme/frontend/default/layout.html";i:1497931165;s:43:"./theme/frontend/default/layout\header.html";i:1499332920;s:43:"./theme/frontend/default/layout\footer.html";i:1498641721;}*/ ?>
<?php
use tpfcore\Core;
        ...
        <div class="blogc-left">
            <div class="blog-post">
                ...
                <article>
                    ...
                    <div class="main">
                        <h5>
						<a target="_blank" href="/frontend/posts/show/id/<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></a>
					</h5>
                        <div class="date"><?php echo date("Y-m-d",$vo['datetime']); ?></div>
                        <div class="content"><?php echo StringHelper::msubstr($vo['content'],0,100); ?></div>
                        <a target="_blank" href="/frontend/posts/show/id/<?php echo $vo['id']; ?>" class="btn-blog">阅读详细</a>
                    </div>
                </article>
